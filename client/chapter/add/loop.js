...
do...while: 조건 확인 전 최소 한 번 실행 후 반복.

for: 지정된 횟수 반복.

for...in: 객체의 속성 반복.

for...of: 반복 가능한 객체의 요소 반복. (주로 배열)
...
for...of 문은 배열의 값만 순차적으로 순환하며, 
배열 순서를 보장하고 인덱스에 대한 걱정 없이 값을 처리할 수 있습니다.
...
반복 가능한(iterable) 객체를 순회(iterate)하는 데 사용하는 반복문입니다. 
배열, 문자열, Map, Set 등의 자료 구조를 순회할 때 유용하게 사용됩니다.
...
element: 반복할 때마다 iterable의 각 요소가 element 변수에 할당됩니다.
iterable: 배열, 문자열, Map, Set 등 반복 가능한 객체를 의미합니다.




for...of와 for...in의 차이
for...of: 반복 가능한 객체의 값을 순회합니다.
for...in: 객체의 **속성 이름(키)**을 순회합니다.
